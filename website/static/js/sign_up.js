  ...
  document
    ...
    function addErrorStyles(element, message) {
      ...
      if (!errorElement) {
        ...
        closeIcon.style.marginLeft = "10px"; // Adjust margin for spacing
    ...
    // Password strength check function (same as before)
    ...
    // Check if email exists in the backend before form submission
    function checkEmailExists(emailValue, callback) {
      ...
      xhr.send("email=" + encodeURIComponent(emailValue.trim()));
    }
